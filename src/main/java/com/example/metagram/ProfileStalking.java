...
//        date = findViewById(R.id.date);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.logs){
            Self.id = ProfileStalking.userId;
            Intent intent = new Intent(ProfileStalking.this, Self.class);
        ...
        if(v.getId() == R.id.sendmsg){
            ...
            Pooja.recieverID = ProfileStalking.userId;
            Intent intent = new Intent(ProfileStalking.this, Pooja.class);
            startActivity(intent);
        }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (imageUrl != null) {
                        ...
                        Glide.with(ProfileStalking.this)
                                .load(imageUrl)
                                .into(pp);
                    } else {
