...
public class PostAdapader extends RecyclerView.Adapter<PostAdapader.Holder> implements View.OnClickListener{
    ...
    public PostAdapader(Context context, List<Post> list, listener listener) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        //DatabaseReference dref = FirebaseDatabase.getInstance().getReference().child("posts").child().child("saved").child(MainActivity.userId);
